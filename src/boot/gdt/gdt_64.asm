...
; aligns the next code or data to an 16 bytes boundary
; if the current address is not divisible by 16, inserts padding bytes
; so the next label starts at an address that is a multiple of 16
align 16
...
; code segment 64 bits protected mode
gdt_64_code_segment:
    dw 0xFFFF ; limit (16 bits)
    dw 0x0000 ; base (16 bits)
    db 0x00 ; base (8 bits)
    db 10011010b ; access byte (8 bits)
    db 10101111b ; flags (4 bits) + limit (4 bits)
    db 0x00 ; base (8 bits)

; data segment 64 bits protected mode
gdt_64_data_segment:
    dw 0xFFFF ; limit (16 bits)
    dw 0x0000 ; base (16 bits)
    db 0x00 ; base (8 bits)
...
; CODE_SEG_64: points to the 2nd entry in the GDT 64 bits table
; DATA_SEG_64: points to the 3rd entry in the GDT 64 bits table
CODE_SEG_64 equ gdt_64_code_segment - gdt_64_start
DATA_SEG_64 equ gdt_64_data_segment - gdt_64_start
